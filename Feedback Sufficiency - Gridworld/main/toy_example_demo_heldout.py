...
normalized_infogain_thresholds = config['suff_config']['normalized_infogain_thresholds']
entropy_confidence_thresholds = config['suff_config']['entropy_confidence_thresholds']
...
for i in range(50):
    ...
    confusion_matrices_held_out = {threshold: [[0, 0], [0, 0]] for threshold in held_out_thresholds}
