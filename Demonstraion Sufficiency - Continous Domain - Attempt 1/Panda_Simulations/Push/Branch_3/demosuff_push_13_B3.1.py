...
- Normalize the mcmc samples
- In compare to 13_B3, the number of mcmc samples is increased to 100 and the step deacresed to 0.4

Reuslt:
- the normalization was not helpful
- After 15 iterations the regret increase !!!!!
...
all_demonstrations, xi_star, main_trajectory_space, f_star = human_demo_2(env, xi0, true_reward_param,\
                                                                           n_samples=num_generated_demos, n_demos=100)
...
for experiment_num in range(n_runs):
    print("=================================================  Experiment Panda Push Branch 13_B3_1 %d =================================================" %experiment_num)
