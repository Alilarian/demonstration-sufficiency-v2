...
- In compare to 14_B3, the number of mcmc samples is increased to 100 and the step deacresed to 0.4
...
for experiment_num in range(n_runs):
    print("=================================================  Experiment Panda Push Branch 14_B3_1 %d =================================================" %experiment_num)
