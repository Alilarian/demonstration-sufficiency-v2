...
- increase mcmc samples to 3000 and step size to 0.1 (which is a bit large for 3000)
"""
...
for experiment_num in range(n_runs):
    print("=================================================  Experiment Panda Push Branch 13_B3.4 %d =================================================" %experiment_num)
