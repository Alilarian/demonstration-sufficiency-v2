...
for experiment_num in range(n_runs):
    ...
    if experiment_num%20 == 0:
        np.save('map_trajectories_B12.7.npy', np.array(map_trajs))
        np.save('mean_trajectories_B12.7.npy', np.array(mean_trajs))
        np.save('optimal_trajectory_B12.7.npy', xi_star)