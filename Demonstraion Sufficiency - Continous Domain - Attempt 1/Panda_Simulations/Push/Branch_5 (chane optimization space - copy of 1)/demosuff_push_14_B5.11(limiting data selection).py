...
all_demonstrations = np.array(all_demonstrations)[:50] # removing the variance in data selecctioon
trajectory_space = np.array(trajectory_space) # Keep the space for traj ooptimization large
