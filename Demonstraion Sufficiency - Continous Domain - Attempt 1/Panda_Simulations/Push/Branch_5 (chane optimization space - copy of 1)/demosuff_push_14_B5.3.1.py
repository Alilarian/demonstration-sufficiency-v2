...
-- deacrese the number of samples 20 and increase the step size to 0.8 in compare to 14_B3
"""
...
all_demonstrations, xi_star, trajectory_space, f_star = human_demo_2(env, xi0, true_reward_param,\
                                                                           n_samples=num_generated_demos, n_demos=200)
...
for experiment_num in range(n_runs):
    print("=================================================  Experiment Panda Push Branch 14_B3.3 %d =================================================" %experiment_num)
