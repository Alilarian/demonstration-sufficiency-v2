...
class Env1():
    ...
    def play_traj(self, xi, T=2.0):
        ...
        p.addUserDebugLine(
            ...
            traj.get_waypoint(sim_time+1/100.0),
            [0, 0, 0],
            100
        )
        ...
        while sim_time < T:
            ...
            #time.sleep(1/100.0) # for real-time visualization
        #print(self.read_box())
    ...
    def feature_count(self, xi):
        ...
        f = np.array([box_move_y, length_reward, box_move_y*length_reward])
        return f
    ...
    def set_camera(self):
        ...
        p.resetDebugVisualizerCamera(cameraDistance=1.2, cameraYaw=60, cameraPitch=-35,
                                     cameraTargetPosition=[1, 0.5, 0]) # x y z
