...
for experiment_num in range(n_runs):
    print("=================================================  Experiment Panda Push Branch 13_B7_1 %d =================================================" %experiment_num)
    ...
    for demonstration in range(num_demonstrations):
        ...
        all_double_mcmc_sample, map_solution = mcmc_naive(env, demonstrations[:demonstration + 1], n_outer_samples, n_burn, \
                   len(true_reward_param), beta, step_size, normalize=normalize)
