...
for experiment_num in range(n_runs):
    print("=================================================  Experiment Panda Close Branch 5.3 %d =================================================" %experiment_num)
    ...
    if experiment_num%20 == 0:
        np.save('results/acceptance_ratio_per_samples_B5.3.npy', acceptance_ratio_per_samples)
        np.save('results/mcmc_samples_B5.3.npy', mcmc_samples_all_experiments)
        np.save('results/map_trajectories_B5.3.npy', np.array(map_trajs))
        np.save('results/mean_trajectories_B5.3.npy', np.array(mean_trajs))
        np.save('results/optimal_trajectory_B5.3.npy', xi_star)
        np.save('results/avar_all_iterations_max_norm_map_policy_B5.3.npy', np.array(avar_all_iterations_max_norm_map_policy))
        np.save('results/true_avar_all_iterations_max_norm_map_policy_B5.3.npy', np.array(true_avar_all_iterations_max_norm_map_policy))
