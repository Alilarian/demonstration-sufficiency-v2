...
np.save('results/best_traj_B5.3.1.npy', all_demonstrations[0])
np.save('results/worst_traj_B5.3.1.npy', all_demonstrations[-1])
...
for experiment_num in range(n_runs):
    ...
    if experiment_num%20 == 0:
        np.save('results/acceptance_ratio_per_samples_B5.3.1.npy', acceptance_ratio_per_samples)
        np.save('results/mcmc_samples_B5.3.1.npy', mcmc_samples_all_experiments)
        np.save('results/map_trajectories_B5.3.1.npy', np.array(map_trajs))
