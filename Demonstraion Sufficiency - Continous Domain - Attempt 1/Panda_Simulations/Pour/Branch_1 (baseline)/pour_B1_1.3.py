...
for experiment_num in range(n_runs):
    ...
    if experiment_num%20 == 0:
        np.save('results/acceptance_ratio_per_samples_B1_3.npy', acceptance_ratio_per_samples)
        np.save('results/mcmc_samples_B1_3.npy', mcmc_samples_all_experiments)
        np.save('results/map_trajectories_B1_3.npy', np.array(map_trajs))
        np.save('results/mean_trajectories_B1_3.npy', np.array(mean_trajs))
        np.save('results/optimal_trajectory_B1_3.npy', xi_star)
        np.save('results/avar_all_iterations_max_norm_map_policy_B1_3.npy', np.array(avar_all_iterations_max_norm_map_policy))
        np.save('results/true_avar_all_iterations_max_norm_map_policy_B1_3.npy', np.array(true_avar_all_iterations_max_norm_map_policy))