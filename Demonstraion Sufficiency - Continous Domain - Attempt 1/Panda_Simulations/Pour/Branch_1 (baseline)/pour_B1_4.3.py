...
trajectory_space = np.load('data/trajectory_space_len5.npy', allow_pickle=True)
demonstration_space = np.load('data/demonstration_space_len5.npy', allow_pickle=True)
xi_star = np.load('data/xi_star_len5.npy', allow_pickle=True)
f_star = np.load('data/f_star_len5.npy', allow_pickle=True)
rewards = np.load('data/rewards_len5.npy', allow_pickle=True)
...
for experiment_num in range(n_runs):
    print("=================================================  Experiment Panda Pour B1_4.3 %d =================================================" %experiment_num)
    ...
    if experiment_num%20 == 0:
        np.save('results/acceptance_ratio_per_samples_B1_4.3.npy', acceptance_ratio_per_samples)
        np.save('results/mcmc_samples_B1_4.3.npy', mcmc_samples_all_experiments)
        np.save('results/map_trajectories_B1_4.3.npy', np.array(map_trajs))
        np.save('results/mean_trajectories_B1_4.3.npy', np.array(mean_trajs))
        np.save('results/optimal_trajectory_B1_4.3.npy', xi_star)
        np.save('results/avar_all_iterations_max_norm_map_policy_B1_4.3.npy', np.array(avar_all_iterations_max_norm_map_policy))
        np.save('results/true_avar_all_iterations_max_norm_map_policy_B1_4.3.npy', np.array(true_avar_all_iterations_max_norm_map_policy))